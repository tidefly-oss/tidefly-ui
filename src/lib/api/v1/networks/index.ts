...
export const networksApi = {
  ...
  containers: (id: string)                         => api.get<{ id: string; name: string }[]>(`/api/v1/networks/${encodeURIComponent(id)}/containers`),
  delete:     (id: string, fetchFn?: typeof fetch) => api.delete<void>(`/api/v1/networks/${id}`, fetchFn),
};