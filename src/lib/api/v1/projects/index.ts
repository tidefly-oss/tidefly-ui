...
import type { CreateProjectRequest, Project, UpdateProjectRequest } from '$lib/api/v1/types/projects.js';
...
export const projectsApi = {
	...
	listContainers: (id: string, fetchFn?: typeof fetch)                            => api.get<Container[]>(`/api/v1/projects/${id}/containers`, fetchFn),
};