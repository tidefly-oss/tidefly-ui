...
export const imagesApi = {
	...
	containers: (id: string) =>
		api.get<{ id: string; name: string }[]>(`/api/v1/images/${encodeURIComponent(id)}/containers`),
	delete: (id: string, force = false, fetchFn?: typeof fetch) =>
		api.delete<void>(`/api/v1/images/${id}?force=${force}`, fetchFn),
};
