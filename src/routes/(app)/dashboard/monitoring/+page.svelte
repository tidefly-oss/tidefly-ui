<script lang="ts">
  ...
  import { ActivityIcon, MonitorIcon, ShieldIcon } from "@lucide/svelte";
  import { onMount } from "svelte";

  type Tab = "system" | "app" | "audit";
...
<div class="space-y-4">
  ...
  <div class="flex gap-1 bg-muted/50 p-1 rounded-lg w-fit">
    <button
      ...
      class="flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-md transition-colors {activeTab ===
      'system'
